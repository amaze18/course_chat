...
class __login__:
    ...
    def __init__(self, auth_token: str, company_name: str, width, height, logout_button_name: str = 'Logout', hide_menu_bool: bool = False, hide_footer_bool: bool = False, lottie_url: str = "https://assets8.lottiefiles.com/packages/lf20_ktwnwv5m.json",allowed_emails_set: set = None ):
        """
        Arguments:
        -----------
        1. self
        ...
        self.allowed_emails_set = allowed_emails_set # Add this line
    ...
    def sign_up_widget(self) -> None:
        ...
        with st.form("Sign Up Form"):
            ...
            valid_email_check = check_valid_email(email_sign_up)
                ...
                #st.error("Unauthorized User: Email ID not allowed.")
                #st.stop()
            unique_email_check = check_unique_email(email_sign_up)
            email_exists_check = check_email_exists(email_sign_up)
            ...
            if sign_up_submit_button:
                ...
                if valid_name_check and valid_email_check and unique_email_check and email_exists_check and unique_username_check:
                    register_status = register_new_usr(name_sign_up, email_sign_up, username_sign_up, password_sign_up)
                    #print("DEBUG: register_status:", register_status)  # Debugging statement
                    if register_status == "User registered successfully.":
                        st.success("Registration Successful!")
                    else:
                        st.error(register_status)
