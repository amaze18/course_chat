...
DEFAULT_CONTEXT_PROMPT_TEMPLATE = """
  ...
  Answer "don't know" if not present in the document. Also, respectfully decline to answer questions that are not related to {output}"
  """
...
if "chat_engine" not in st.session_state.keys(): # Initialize the chat engine
        st.session_state.chat_engine = CondensePlusContextChatEngine.from_defaults(query_engine,context_prompt=DEFAULT_CONTEXT_PROMPT_TEMPLATE.format(output=output))
